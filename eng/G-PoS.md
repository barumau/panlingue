...
Morphemes are the roots, affixes and endings in Panlingue.
Their job is to help to build the vocabulary of Panlingue.
The endings also help to organize the syntax.

One of the first things that an typical person notices about Panlingue is that its words seldom change.
Most words in Panlingue have one unchanging form,
...
Compare, for example, what happens to the words in the following two sentences in Panlingue and English.
...
In Panlingue, the pronouns *me* 'I' and *ho* 'he or she' simply change places and that's it.
...
Panlingue is not an isolating language, but it has very few grammatical inflections indeed.
There are only two inflections in Panlingue, the verb endings *-a* and *-u*,
...
Panlingue is an exceptionally simple language.
It is so simple that we don't need specialized or complicated words to describe how it works.
...
Panlingue courses can be made so that there is maximum similarity between the source language and the target language (Panlingue) in early stages of learning.
...
These endings and the participles (*-n-* and *-t-*) are the only true suffixes i.e. bound morphemes in Panlingue.
