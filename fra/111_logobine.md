...
Ces terminaisons vocaliques permettent facilement à une racine de passer d'une catégorie grammaticale à l'autre.
...
Crée des noms d'objets subissant une action à partir de la racine de cette action. Il marque une personne ou une chose sur qui on agit, on fait une action.

**kriata** créer ; **kriatur** créature, ce qui est créé  
**morta** tuer ; **mortur** celui / celle qui est tué.e ; par extension : un martyr
**folda** plier ; **foldur** quelque chose qui est plié, pliage ; par extension : un dossier
