# Comment écrire en panlingue

Le panlingue utilise l’alphabet latin de base pour son écriture.
Voici les lettres du panlingue ainsi que les symboles de l’alphabet phonétique international (API).
...
Le panlingue se prononce exactement comme il s’écrit, comme l’espagnol.
...
Le Panlingue a 6 voyelles.

Elles se prononcent comme suit :
**a** comme dans _papa_,
**e** comme le « é » de _café_,
**i** comme dans _joli_,
**o** comme le « eau » de _chapeau_,
**u** comme le « ou » de  _hibou_ et
**ə** comme le « e » de  _ce_.
Ce sont des voyelles pures, donc leur qualité ne change pas au cours de leur durée.
...
Les consonnes suivantes se prononcent différement en panlingue et en français :
...
- **dunia** /dúnia/, **arabia** /arábia/
    ...
    /dúnia sá mómi sundári planéte./
     ...
     me vola loga komuni bashe, le sa panlingue.  
    /mé wóla lóga komúni báʃe, lé sá pandúnia./


## Majuscules

Le panlingue s’écrit normalement en minuscules.
...
Lors de textes informels, des émoticones et des emojis peuvent être utilisés pour indiquer une humeur.
