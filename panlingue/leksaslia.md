...
sing ← ind:singa. hin:सिंघ (singh). ben:সিংহ (singh). tam:சிங்கம் (sinkam). tha:สิง (sing). zho:狮 (shī). jpn:獅子 (shishi). + swa:simba.  
sirke ← tur:sirke. fas:(serke). hin:सिरका (sirkā). pnb:ਸਿਰਕਾ (sirkā).  
site ← eng:city. fra:cité. + zho:市 (shì). kor:시 (si). jpn:都市 (toshi).  
socia ← rus:социум (socium). eng:society. spa:sociedad.  
sofah ← spa:por:sofá. eng:fra:deu:ind:sofa. rus:софа (sofa). zho:沙发 (shāfā). yue:梳化 (so1faa23). wuu:沙发 (sufa). jpn:ソファ (sofa). kor:소파 (sopa). tgl:sopa. tha:โซฟา (soo-faa). hin:सोफ़ा (sofā). ben:সোফা (sopha).  
soke ← deu:Socke. eng:sock. swa:soksi. zul:isokisi. jpn:ソックス (sokkusu). rus:носок (nosok).   
sol ← spa:por:sol. fra:soleil. + hin:सौर (sOr). tel:(saur).  
son ← rus:сон (son). por:sono. hin:सोना (sonā).  
sonde ← eng:sound,sonic. fra:son. spa:son,sonido. ita:suono. + kor:소리 "sori".  
...
sosis ← fra:saucisse. tur:ind:sosis. fas:(sosis). rus:сосиска  (sosiska). jpn:ソーセージ (sosēji). hin:सॉसेज (sosej). ben:সসেজ (sôsej). eng:sausage.  
suan ← zho:酸 (suān).  
...
sukar ← ara:(sukkar). swa:sukari. por:açúcar. spa:azúcar. kon:sukadi. hin:शक्कर (śakkar). tam:சக்கரை (cakkarai).  
suki ← hin:सुखी "sukhī". jpn:好き "suki". tha: สุข /suk/.  
suku ← jpn:好く (suku). ind: suka.  
sun ← eng:soon.  
...
tafun ← zho:大风 (dàfēng). yue:大風 (daai6fung1). kor:태풍 (taepung). jpn:台風 (taifuu). tha:ไต้ฝุ่น (taifun). ara:(ṭūfān). fas:urd:(tufān). hin:तूफ़ान (tūfān). pnb:ਤੂਫ਼ਾਨ (tūfān). por:tufão. spa:tifón. fra:typhon. eng:typhoon. rus:тайфун (tayfun).  
...
tape ← spa:tur:tapa. por:tampa. ell:τάπα (tapa). bul:тапа (tapa). eng:tap.  
...
tawe ← hin:तवा (tavā). tur:tava. fas:(tābe).  
tazi ← tur:taze. hin:ताज़ा (tāzā). ben:তাজা (taja). kaz:таза (taza). fas:(tâze).  
...
tezi ← hin:तेज़ (tez). urd:(tez). fas:(tiz). aze:uzb:tez. kaz:тез (tez).  
tike ← fas:(tekke). arm:թիքա (tʿikʿa). hin:टिक्का (ṭikkā).  
tikete ← eng:deu:ticket. ind:tiket. hin:टिकट (ṭikaṭ). urd:(ṭikaṭ). ben:টিকিট (ṭikiṭ). amh:ቲኬት (tiket). kor:티켓 (tiket). jpn:チケット (chiketto).  
tin ← hin:तीन (tīn). ben:তিন (tin). urd:(tīn).  
...
tong ← zho:桶 (tǒng). khm:តុង (tong). tha:ถัง (tǎng). kor:통 (tong). vie:thùng. ind:mal:tong. + fra:tonneau. spa:tonel. ned:ton.  
...
urse ← fra:ours. por:urso. spa:oso. fas:(xers).  
uza ← eng:use. spa:usar. pol:używać.  
##v  
##w  
wain ← fra:vin. spa:vino. rus:вино (vino). eng:wine. deu:Wein. hin:वाइन (vāin). jpn:ワイン (wain).  
wale ← por:vale. eng:valley. fra:vallée. spa:valle.  
wanta ← eng:want.  
waris ← ind:waris. ara:(wariþ). swa:urithi. tur:varis,miras.  
warke ← ara:(waraqa). hau:warƙa. tur:varak. fas:(varaqe). taj:варақа (varaqa). swa:waraka. + mya:အရွက် (arwak).  
wase ← ara:"wāḥa". tur:vaha. fas:"vāhe". spa:oasis.  
waw ← zho:哇 "wā". eng:wow.  
waxa ← eng:wash. deu:waschen. zho:洗 "xǐ".  
way dexi ← hin:"videśī". tel:"vidēśi". zho:外国的 "wàiguóde".  
waye ← zho:外 (wài).  
waze ← deu:eng:fra:vase. pol:waza. rus:ваза (vaza). tur:vazo. tkm:waza.  
weje ← eng:vegetable,veg. spa:vegetal.  
weri ← eng:very. ita:vero. spa:verdadero. por:verdadeiro. deu:wahr. fra:vrai.  
werke ← ben:কাজ "kaj". ind:kerja. tha:การ "gaan".  
werme ← eng:worm. por:verme. fra:ver. deu:Wurm.  
wersion ← eng:fra:version. por:versão. rus:версия (versiya). ind:versi.  
wida ← rus:видеть (videt). ita:vedere. spa:por:ver. pol:widzieć. cze:vidět. ron:uita.  
...
wote ← eng:vote. spa:por:voto. hin:वोट (voṭ). rus:вотум (votum).  
##x  
...
xibay ← zho:失败 (shībài). jpn:失敗 (shippai). kor:실패 (šilpæ). vie:thất bại.  
xim ← kor: 심 (shim). zho:心 (xīn). jpn:心 (shin). yue:心 (sam1). hak:心 (sîm). vie:tim.  
xin ← zho:信 (xìn). yue:信 (seon3). jpn:信 (shin). vie:tin.  
xindawistia ← jpn:神道 (shintō). kor:신도 (sindo). zho:神道 (shéndào).  
xing ← zho:星 (xīng). wuu:星 (xing). yue:星 (sing1). jpn:星 (sei). kor:성 (seong).  
xir ← heb:שיר (šir). ara:(šiʿr). tur:şiir. fas:(še'r). swa:shairi. zho:诗 (shī). yue:詩 (si1). jpn:詩 (shi). kor:시 (shi).   
...
ziper ← eng:zipper. ben:জিপার (jipar). hin:ज़िपर (zipar). jpn:ジッパー (jippā). kor:지퍼 (jipeo). tha:ซิป (síp). fas:urd:(zip).  
...
zumrude ← ara:(zumurrud). fas:(zomorrod). tur:zümrüt. ind:zamrud. rus:изумруд (izumrud). swa:zumaridi.  
