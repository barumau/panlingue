#!/bin/bash
kitaba_pike() {
   echo "#asar la mulbax va panlingue" > panlingue/asar_da_mulbax.md
   echo "" >> panlingue/asar_da_mulbax.md
   echo "| bax | asar |" >> panlingue/asar_da_mulbax.md
   echo "|-----|--------|" >> panlingue/asar_da_mulbax.md
   cat temp/stats.txt >> panlingue/asar_da_mulbax.md
}
