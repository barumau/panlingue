...
(SI) are used in common language in Panlingue.
...
and we never use words like *past* and *to* in Panlingue.
...
Normally we use the 24 hour clock to tell the time in Panlingue.
