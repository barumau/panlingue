...
These are the basic rules of the Panlingue language.
They are described in more detail later in this document.

1.  **World words**

    Panlingue is an evenly global language.
    International words are borrowed from all parts of the world to Panlingue.
    They are adapted to the pronunciation and orthography of Panlingue.
...
4.  **Word class markers**
    ...
    Panlingue words consist of a root and a word class marker.
    ...
    *-a* and *-u* for verbs,
    ...
    This consistent system is a key factor of Panlingue's grammatical clarity
